...
- (void)viewDidLoad
{
    ...
    sortedArray = [[NSArray alloc]initWithObjects:@"Date Modified",@"Date Added",@"Date Created",@"Size", nil];
...
-(void)DisplayVendors
{
    ...
    if(totalVendors%3==0)
    {
        ...
        vendorScroller.contentSize = CGSizeMake(748,237*totalVendors/3+10);
    }
    else
    {
        vendorScroller.contentSize = CGSizeMake(748,(237*totalVendors/3)+100);
        ...
        if(totalVendors%4==0)
        {
            ...
            vendorScroller.contentSize = CGSizeMake(1006,237*totalVendors/4+10);
        }
        else
        {
            vendorScroller.contentSize = CGSizeMake(1006,(237*totalVendors/4)+100);
    ...
    if (listAndGridIndex==2)
    {
        ...
        vendorScroller.contentSize = CGSizeMake(748, m*totalVendors);
        vendorScrollerLand.contentSize = CGSizeMake(1006, m*totalVendors);
